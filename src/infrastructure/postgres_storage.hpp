...
class PostgresStorage final : public Storage {
 public:
  explicit PostgresStorage(std::string connectionString);
  ...
  bool updateRelease(const std::string& tenantId, const std::string& releaseId, const std::string& status,
                     int expectedVersion) override;
